...
class TestEmployee(unittest.TestCase):
    ...
    def test_employee_full_name(self):
        self.emp = Employee("Ivanov", "Ivan", "Ivanovich", 30, "Plumber", 40_000.0)
    ...
    def test_employee_raise_salary(self):
        ...
        self.assertEqual(self.emp.salary, 44000.0)

    def test_employee_str(self):
        self.emp = Employee("Ivanov", "Ivan", "Ivanovich", 30, "Plumber", 40_000.0)
        self.assertEqual(self.emp.__str__(), "Ivanov Ivan Ivanovich (Plumber)")
