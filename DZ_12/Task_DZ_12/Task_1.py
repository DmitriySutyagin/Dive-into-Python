...
def generate_csv_file(file_name: str):
    """ The function generates three random numbers in each line, from 100-1000 lines, and writes them to a CSV file """
    __spisok_predmetov = ['Математика','Физика','История','Литература']

    with open(file_name, 'w', encoding='utf-8', newline='') as c:
        csv_file = csv.writer(c)
        csv_file.writerow(__spisok_predmetov)
...
generate_csv_file('subjects.csv')
...
student.add_grade("Литература", 2)
